...
def checkResponse(response, answer):
    ...
    if response == answer:
        ...
        print(f'Mauvaise réponse !, la réponse est: {answer}\n')

# Affichage du score
def showScore():
    print('Le jeux est terminer !')
    print(f'Score total: {score}/20.')
    input('\nPour quitter, appuyer sur la touche entrée ...')

# Main
print("\n\n\t\t***************************************")
print("\n\n\t\t QUIZZ SUR LES FONCTIONS MATHÉMATIQUES ")
print("\n\n\t\t***************************************")
print("\n\n")
